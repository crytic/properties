...
/**
 * @title ERC1155 Mintable Properties
 * @author Crytic (Trail of Bits)
 * @notice Invariant properties for ERC1155 tokens with mint functionality
 * @dev Testing Mode: INTERNAL
 * @dev This contract contains properties that must hold for ERC1155 implementations
 * with mint functionality. These properties ensure that minting tokens correctly
 * increases balances for both single and batch operations.
 *
 ...
 *
 * Note: The mint function must be implemented by the inheriting contract as
...
abstract contract CryticERC1155MintableProperties is CryticERC1155TestBase {
    ...
    // Should be modified if target contract's function names are different
     ...
     * @custom:property-id ERC1155-MINT-001
     *
     * @param target The address to mint tokens to
     * @param tokenId The token ID to mint
     * @param amount The amount to mint
     */
    function test_ERC1155_mintIncreasesBalance(
        address target,
        uint256 tokenId,
        uint256 amount
    ) public {
        require(target != address(0));
        uint256 balance = balanceOf(target, tokenId);

        this.mint(target, tokenId, amount, "");

        assertEq(
            balanceOf(target, tokenId),
            balance + amount,
     ...
     * @custom:property-id ERC1155-MINT-002
     *
     * @param tokenId The token ID to mint
     * @param amount The amount to mint
     */
    function test_ERC1155_mintToZeroAddress(uint256 tokenId, uint256 amount) public {
     ...
     * @custom:property-id ERC1155-MINT-003
     *
     * @param tokenId The token ID to mint
     * @param amount The amount to mint
     */
    function test_ERC1155_mintToNonReceiverContract(uint256 tokenId, uint256 amount) public {
        require(amount > 0);
     ...
     * @custom:property-id ERC1155-MINT-004
     *
     * @param tokenId The token ID to mint
     * @param amount The amount to mint
     */
    function test_ERC1155_mintToValidReceiver(uint256 tokenId, uint256 amount) public {
        require(amount > 0);
     ...
     * @custom:property-id ERC1155-MINT-005
     *
     * @param target The address to mint tokens to
     ...
     */
    function test_ERC1155_batchMintIncreasesBalances(
        address target,
        uint256 tokenId1,
        uint256 tokenId2,
        uint256 amount1,
        ...
        uint256 balance1 = balanceOf(target, tokenId1);
        uint256 balance2 = balanceOf(target, tokenId2);
        ...
        assertEq(
            balanceOf(target, tokenId1),
            balance1 + amount1,
            "Balance 1 not increased correctly after batch mint"
        );
        assertEq(
            balanceOf(target, tokenId2),
            balance2 + amount2,
     ...
     * @custom:property-id ERC1155-MINT-006
     *
     * @param target The address to mint tokens to
     */
    function test_ERC1155_batchMintArrayLengthMismatch(address target) public {
        require(target != address(0));
        ...
        this.mintBatch(target, ids, amounts, "");
        assertWithMsg(false, "Batch mint with mismatched arrays should have reverted");
    }
     ...
     * @custom:property-id ERC1155-MINT-007
     *
     * @param tokenId The token ID to mint
     * @param amount The amount to mint
     */
    function test_ERC1155_batchMintToZeroAddress(uint256 tokenId, uint256 amount) public {
     ...
     * @custom:property-id ERC1155-MINT-008
     *
     * @param tokenId The token ID to mint
     * @param amount The amount to mint
     */
    function test_ERC1155_batchMintToNonReceiverContract(
        uint256 tokenId,
        uint256 amount
    ) public {
        require(amount > 0);
        ...
        assertWithMsg(false, "Batch mint to non-receiver contract should have reverted");
    }
}
